...
export default function useAudio(enabled) {
  ...
  const play = useCallback((name) => {
    ...
    switch (name) {
      ...
      case 'clear':  [523, 659, 784].forEach((f, i) => tone(ctx, f, i * 0.06, 0.14, 'triangle', 0.07)); break;
      case 'tetris': [523, 659, 784, 1046].forEach((f, i) => tone(ctx, f, i * 0.07, 0.2, 'square', 0.08)); break;
